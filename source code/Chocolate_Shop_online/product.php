				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">$'.$row['product_price'].'<del class="product-old-price">$1550.00</del></h3>
								<span class="product-available">In Stock</span>
							</div>
							<p>Là sản phảm đến từ thương hiệu của Mỹ được rất nhiều người ưa chuộng và sử dụng	.</p>
												...
												<ul class="reviews">
													<li>
														...
														<div class="review-body">
															<p>San pham dang duoc su dung , do ben tot, chat luong san pham tuyet, toi se ung ho shop nhieu hon nua</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Demi</h5>
															<p class="date">27 DEC 2018, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
